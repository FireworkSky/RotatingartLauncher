...
public class SDLControllerManager
{
    ...
    // RAL: Virtual Xbox Controller support
    ...
    // RAL: Get virtual controller instance
...
class SDLJoystickHandler_API16 extends SDLJoystickHandler {
    ...
    // RAL: Changed from private to protected for VirtualJoystick subclass access
...
class SDLHapticHandler_API31 extends SDLHapticHandler {
    ...
    public void rumble(int device_id, float low_frequency_intensity, float high_frequency_intensity, int length) {
        // RAL: Check VIBRATOR_SERVICE for virtual controller
        if (device_id == deviceId_VIBRATOR_SERVICE) {
            try {
                ...
                // If SettingsManager is not available, do nothing
            }
            return;
        }
...
class SDLHapticHandler {
    ...
    // RAL: Device ID for VIBRATOR_SERVICE (used for virtual controller vibration)
    public static final int deviceId_VIBRATOR_SERVICE = 999999;
...
// RAL: Virtual Xbox Controller Handler for SDL3
        ...
        for (int device_id : deviceIds) {
            if (SDLControllerManager.isDeviceSDLJoystick(device_id)) {
                ...
                if (joystick == null) {
                    ...
                    mJoysticks.add(joystick);
                    // SDL3 API: no is_accelerometer and nballs parameters
