...
*/
    ...
    protected void main() {
        ...
        // RAL: Call Main(args) method for backwards compatibility
        Main(arguments);
    }

    /**
     * RAL: The application entry point with arguments.
     * Can be overridden by derived classes for custom launch logic.
     */
    ...
    // RAL 虚拟控件触摸点管理 - 被标记的触摸点不会转换为鼠标事件
