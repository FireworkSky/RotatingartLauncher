...
internal class StartupHook
{
    ...
    {
        Console.WriteLine("[StartupHook] TModLoaderPatch DOTNET_STARTUP_HOOKS executing...");
        ...
        Console.WriteLine($"[StartupHook] TModLoaderPatch.Patcher.Initialize returned: {result}");
    }
